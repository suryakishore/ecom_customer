...
public class HistoryProductDetailAdapter extends
  ...
  @NonNull
  @Override
  public HistoryProductDetailAdapter.HistoryProductDetailViewHolder onCreateViewHolder(
  ...
  public void onBindViewHolder(
      @NonNull HistoryProductDetailAdapter.HistoryProductDetailViewHolder holder, int position) {
