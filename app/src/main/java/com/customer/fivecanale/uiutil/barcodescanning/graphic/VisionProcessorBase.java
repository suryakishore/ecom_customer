...
package com.customer.fivecanale.uiutil.barcodescanning.graphic;

import android.graphics.Bitmap;
import androidx.annotation.GuardedBy;
import androidx.annotation.NonNull;
import androidx.annotation.Nullable;
import com.customer.fivecanale.uiutil.barcodescanning.barcode.BitmapUtils;
...
/**
 * Abstract base class for ML Kit frame processors. Subclasses need to implement
 * to define what they want to with the detection
