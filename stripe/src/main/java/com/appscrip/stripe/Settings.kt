...
class Settings(context: Context) {
    ...
    private companion object {
         ...
         */
        private const val PUBLISHABLE_KEY = BuildConfig.PUBLISHABLE_KEY
        ...
        private const val METADATA_KEY_BACKEND_URL_KEY =
            "com.appscrip.stripe.metadata.backend_url"
        private const val METADATA_KEY_PUBLISHABLE_KEY =
            "com.appscrip.stripe.metadata.publishable_key"
        private const val METADATA_KEY_STRIPE_ACCOUNT_ID =
            "com.appscrip.stripe.metadata.stripe_account_id"
    }
}
