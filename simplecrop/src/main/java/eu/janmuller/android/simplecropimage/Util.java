...
public class Util {
    ...
    /*
     * Compute the activity_save_address size as a function of minSideLength
     * and maxNumOfPixels.
     ...
     *
     * The function returns a activity_save_address size based on the constraints.
     * Both size and minSideLength can be passed in as IImage.UNCONSTRAINED,
     * which indicates no care of the corresponding constraint.
     * The functions prefers returning a activity_save_address size that
